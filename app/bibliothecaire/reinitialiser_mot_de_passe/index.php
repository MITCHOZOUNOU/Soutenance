...
include 'app/commun/header.php'; //die(var_dump($params[3]));
...
<?php
                                ...
                                <form class="row needs-validation" action="<?= PROJECT_ROM ?>bibliothecaire/reinitialiser_mot_de_passe/traitement" method="post">
