...
if(empty($erreurs)){
    $user = check_if_user_exist($data["nom_utilisateur"], $data["mot_de_passe"], "administrateur", 1 );
    ...
    if (!empty($user)){
        ...
        header('location:' . PROJECT_ROM . 'administrateur/dashboard');
    }else{
...
header('location:' . PROJECT_ROM . 'administrateur/connexion');
