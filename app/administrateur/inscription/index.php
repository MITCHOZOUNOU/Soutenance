...
if (check_if_user_connected()){
  header('location:' . PROJECT_ROM . 'administrateur/dashboardcontact');
  exit;
}
        ...
        <div class="row justify-content-center" style="margin-top: 50px;">
          <div class="col-md-5">
            <div class="card mb-4 mx-4">
              ...
              <form action="<?= PROJECT_ROM ?>aministrateur/inscription/traitement" method="post" class="row g-3 needs-validation">
              <div class="col-12 mb-3">
                    ...
                    <div class="col-12 mt-3">
                      ...
                      <div class="col-12 mt-3">
                        <p class="small mb-0">Vous aviez déjà un compte? <a href="<?= PROJECT_ROM ?>aministrateur/connexion">Se Connecter</a></p>
                      </div>
          </form> 
          </div>
        </div>
